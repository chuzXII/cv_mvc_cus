<div class="owl-carousel owl-theme counter-carousel owl-rtl owl-loaded ">
    ...
    <div class="card border-0 zoom-in bg-warning-subtle shadow-none">
      <div class="card-body">
        <div class="text-center">
          ...
          <h5 class="fw-semibold text-warning mb-0">1</h5>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
      <div class="card-body">
        <div class="text-center">
          ...
          <p class="fw-semibold fs-3 text-danger mb-1">user</p>
